 ...
 */
#ifndef FLASHOMNI_ATTENTION_VARIANT_HELPER_H
#define FLASHOMNI_ATTENTION_VARIANT_HELPER_H
...
// #define REGISTER_Sparse_KV_Info(params, batch_idx, qo_idx, kv_idx, qo_head_idx, kv_head_idx, ...) \
//   template <typename Params>                                                                   \
//   __device__ __forceinline__ bool SparseKVInfo(const Params& params, uint32_t batch_idx,  \
//                                              uint32_t qo_idx, uint32_t kv_idx,                 \
//                                              uint32_t qo_head_idx, uint32_t kv_head_idx) {     \
//     __VA_ARGS__                                                                                \
//   }
...
#endif  // FLASHOMNI_ATTENTION_VARIANT_HELPER_H

 ...
 */
#ifndef FLASHOMNI_CUTLASS_UTILS_CUH_
#define FLASHOMNI_CUTLASS_UTILS_CUH_
...
template <>
struct cutlass_dtype<int8_t> {
  using type = cutlass::int8_t;
};
...
#endif  // FLASHOMNI_CUTLASS_UTILS_CUH_

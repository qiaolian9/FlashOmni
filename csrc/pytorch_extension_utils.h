...
#ifdef FLASHOMNI_ENABLE_BF16
#include <cuda_bf16.h>
#endif

#ifdef FLASHOMNI_ENABLE_F16
#include <cuda_fp16.h>
#endif

#if defined(FLASHOMNI_ENABLE_FP8_E4M3) || defined(FLASHOMNI_ENABLE_FP8_E5M2)
#include <cuda_fp8.h>
#endif

#ifndef FLASHOMNI_EXT_MODULE_INITED
#define FLASHOMNI_EXT_MODULE_INITED

// To expand macros in #name
#define FLASHOMNI_EXT_MODULE_INIT_EXPAND(name) FLASHOMNI_EXT_MODULE_INIT(name)
...
/* Creates a dummy empty module that can be imported from Python.
   ...
   are run. */
#define FLASHOMNI_EXT_MODULE_INIT(name)                                  \
  extern "C" {                                                            \
...
FLASHOMNI_EXT_MODULE_INIT_EXPAND(TORCH_EXTENSION_NAME)

#undef FLASHOMNI_EXT_MODULE_INIT
#undef FLASHOMNI_EXT_MODULE_INIT_EXPAND
...
#ifdef FLASHOMNI_ENABLE_INT8
#define _DISPATCH_CASE_INT8(c_type, ...) \
...
// #ifdef FLASHOMNI_ENABLE_UINT8
// #define _DISPATCH_CASE_UINT8(c_type, ...) \
...
#ifdef FLASHOMNI_ENABLE_FP8_E4M3
...
#ifdef FLASHOMNI_ENABLE_FP8_E5M2
...
#define DISPATCH_PYTORCH_DTYPE_TO_CTYPE_INT8(pytorch_dtype, c_type, ...)                 \
  [&]() -> bool {                                                                        \
    switch (pytorch_dtype) {                                                             \
      _DISPATCH_CASE_INT8(c_type, __VA_ARGS__)                                            \
      default:                                                                           \
        std::ostringstream oss;                                                          \
        oss << __PRETTY_FUNCTION__ << " failed to dispatch data type " << pytorch_dtype; \
        TORCH_CHECK(false, oss.str());                                                   \
